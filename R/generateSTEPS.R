...
#' @param q.b - number of nonzero covariates for primary trait
#' @param A_coef - px1 matrix of true secondary trait parameter values
#' @param B_coef - px1 matrix of true primary trait paramter values
#' @param gam - true correlation between primary and secondary traits (default=1)
#' @param A_int- Intercept for secondary trait model. (default=0)
#' @param B_int- Intercept for primary trait model. (default=0)
